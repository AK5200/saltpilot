        ...
        <div className="max-w-3xl mx-auto rounded-3xl border border-white/20 overflow-hidden shadow-[0_0_0_1px_rgba(255,255,255,0.05),0_8px_40px_rgba(0,0,0,0.4)] bg-white/[0.03]">
            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <span className="w-6 h-6 rounded-full bg-white/10 text-white/60 text-xs flex items-center justify-center font-semibold">1</span>
                  <span className="text-xs font-semibold uppercase tracking-widest text-muted-foreground">One-Time Setup</span>
                </div>
                <p className="text-sm text-muted-foreground mt-1">Everything needed to get your AI receptionist live.</p>
              </div>
          ...
          <div className="p-8 md:p-10">
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-6">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <span className="w-6 h-6 rounded-full bg-white/10 text-white/60 text-xs flex items-center justify-center font-semibold">2</span>
                  <span className="text-xs font-semibold uppercase tracking-widest text-muted-foreground">Then Monthly</span>
                </div>
                <p className="text-sm text-muted-foreground mt-1">Keep your AI receptionist running 24/7.</p>
              </div>
              <div className="flex-shrink-0 text-right">
                <span className="text-4xl font-bold text-foreground">$399</span>
                <span className="text-muted-foreground text-sm">/month</span>
                <p className="text-xs text-muted-foreground mt-1">Additional usage billed separately.</p>
              </div>
            </div>
            <ul className="grid sm:grid-cols-2 gap-2">
          ...
          {/* CTA */}
          <div className="px-8 md:px-10 py-6 bg-white/5 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
